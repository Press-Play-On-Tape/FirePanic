...
namespace Images {
  ...
  const unsigned char PROGMEM Ambulance_Lights_Mask[] = {
  7, 6,
...
0x01, 0x03, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x00, 0x00, 
  ...
  const unsigned char PROGMEM Victims[] = {
  16, 15,
  ...
  const unsigned char PROGMEM Victims_Mask[] = {
  ...
  const unsigned char PROGMEM Victim_Halos[] = {
  12, 5,
  ...
  const unsigned char PROGMEM Victim_Halos_Mask[] = {
